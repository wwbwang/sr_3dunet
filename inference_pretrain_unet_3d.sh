...
CUDA_VISIBLE_DEVICES=0 python scripts/inference_pretrained.py \
    ...
    -i /share/home/wangwb/workspace/sr_3dunet/datasets/bigtif\
    ...
    --piece_flag True --piece_size 128 --piece_overlap 16 --piece_mod_size 16 --remove_size 0 --rotated_flag False
