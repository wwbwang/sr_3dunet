...
do
    ...
    do 
        CUDA_VISIBLE_DEVICES=0 python scripts/inference_debug.py \
            ...
            --model_back_path ./experiments/${branch_name}/models/net_g_B_${iter}.pth\
            --piece_flag False --piece_size 64 --piece_overlap 16 --remove_size 0 --rotated_flag False
    done
done
