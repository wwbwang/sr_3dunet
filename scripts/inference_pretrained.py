...
def get_inference_model(args, device) -> UNet_3d_Generator:
    ...
    # set up model
    model = UNet_3d_Generator(in_channels=1, out_channels=1, features=[64, 128, 256, 512], norm_type='instance', dim=2)
    model_back = UNet_3d_Generator(in_channels=1, out_channels=1, features=[64, 128, 256, 512], norm_type='instance', dim=2)
